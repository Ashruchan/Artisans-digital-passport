...
const navItems = [
  { to: "/artisan/home", labelKey: "artisanPortal.navHome", icon: Home, end: true },
  { to: "/artisan/products", labelKey: "artisanPortal.navProducts", icon: Package },
  { to: "/artisan/create", labelKey: "artisanPortal.navCreate", icon: IdCard },
  { to: "/artisan/qr", labelKey: "artisanPortal.navQr", icon: QrCode },
  { to: "/artisan/earnings", labelKey: "artisanPortal.navEarnings", icon: Wallet },
];
